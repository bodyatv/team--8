...
gf = open('./239.circles', 'r') # Read the ground-truth
pf = open('./240.circles', 'r') # Read the predictions
...
for k in circlesP.keys():  
  if not k in circlesG:
    print ("Ground-truth has prediction for user", k, "but user does not exist")
    sys.exit(0)
